...
{
    public class ScrollAndFadeMode : IChatDisplayMode
    {
        public string Name => "Скролл и исчезновение";
        public string Description => "Сообщения появляются, скроллятся и исчезают через время";
