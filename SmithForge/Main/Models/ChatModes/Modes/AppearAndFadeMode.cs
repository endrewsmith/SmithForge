...
{
    public class AppearAndFadeMode : IChatDisplayMode
    {
        public string Name => "Появление и исчезновение";
        public string Description => "Сообщения появляются с анимацией и исчезают через время";

        private readonly IAppearBehavior _appear = new FadeInAppear();
        private readonly ILifecycleBehavior _lifecycle = new FadeAfterTime();
